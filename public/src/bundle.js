    ...
    _createClass(SearchResults, [{
        ...
        value: function componentDidUpdate(prevProps, prevState) {
            ...
            if (prevProps.searchText !== this.props.searchText) {
                var url = "http://localhost:3000/users/" + this.props.param + "/" + this.props.searchText;
                        ...
                        return _react2.default.createElement(
                            "li",
                            {
                                ...
                                onClick: function onClick() {
                                    _this3.props.handleShowUserInfo(user.name, user.line1, user.line2, user.city, user.state, user.zip, user.phone);
                                }
                            },
                            user.name
                        );
...
var _UserSearch = __webpack_require__(28);

var _UserSearch2 = _interopRequireDefault(_UserSearch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_UserSearch2.default, null), document.getElementById('app'));
...
var _ShowUserInfo = __webpack_require__(30);

var _ShowUserInfo2 = _interopRequireDefault(_ShowUserInfo);
...
var UserSearch = function (_React$Component) {
    ...
    function UserSearch(props) {
        ...
        _this.handleShowUserInfo = _this.handleShowUserInfo.bind(_this);
        _this.state = {
            name: "",
            line1: "",
            line2: "",
    ...
    _createClass(UserSearch, [{
        key: 'handleShowUserInfo',
        value: function handleShowUserInfo(name, line1, line2, city, state, zip, phone) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_ShowUserInfo2.default, {
...
var SearchBar = function (_React$Component) {
    ...
    _createClass(SearchBar, [{
        ...
        value: function handleSearch(e) {
            e.preventDefault();
            var searchField = e.target.elements.searchText.value.trim();
            var parameter = this.state.param;
        ...
        key: 'handleParameter',
        value: function handleParameter(val) {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                this.state.values.map(function (option) {
                                    return _react2.default.createElement(
                                        'li',
                                        { key: option, className: 'cursor' },
                                        _react2.default.createElement(
                                            'a',
                                            { value: option, onClick: function onClick() {
                                                    return _this2.handleParameter(option);
                                                } },
                                            ' ',
                                            option
                                        )
                        ...
                        _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'searchText', 'aria-label': '' }),
                        _react2.default.createElement(
                            'div',
                            { className: 'input-group-btn' },
                            _react2.default.createElement(
